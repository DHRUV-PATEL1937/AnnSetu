...
export default function Landing({ user, onGoToLogin, onGoToRegister, onQuickLogin, onBackToWorkspace }) {
    ...
    <div className="landing-page">
      ...
      <section className="landing-hero">
        ...
        <h1 className="hero-title">
          India's Connected Grid for <span className="highlight-text">Zero Food Waste</span> & Verified Redistribution
        </h1>
      ...
      <section className="demo-launcher-bar">
        <div className="demo-launcher-content">
          <div className="demo-launcher-text">
            ...
            <p>Select any role below to enter the full workspace immediately as a demo participant:</p>
          </div>
      ...
      <section id="roles" className="landing-section roles-section">
        <div className="section-header">
          ...
          <p>
            AnnSetu preserves strict role permissions and distinct workflows so every participant has
      ...
      <section id="features" className="landing-section features-section">
        ...
        <div className="features-grid">
          <div className="feature-box">
            ...
            <p>
              Natural language food intelligence answering freshness questions, batch conversions, and
              demand analysis with Indian dietary context.
            </p>
          </div>
          ...
          <div className="feature-box">
            ...
            <p>
              Instant notification center warning of expiring batches, cold-chain temperature excursions,
              and pending recipient delivery confirmations.
            </p>
          </div>
