    ...
    <div className="app">
      ...
      <aside className={`sidebar ${mobile ? 'mobile-open' : ''}`}>
        ...
        <div className="sidebar-bottom">
          ...
          <button className="settings" onClick={() => setViewingAbout(true)}>
              ...
              >
                ...
                {(data?.metrics?.alerts > 0 ||
                  ...
                  data?.batches?.some((b) => {
                    ...
                    return (
                      h > 0 && h <= 4 && !['confirmed', 'delivered', 'rejected'].includes(b.status)
                    );
                  })) && <i className="pulse" />}
              </button>
              <NotificationPopover
              ...
              <div className="page-header">
                ...
                <div className="page-actions">
                  {isProducer && ['Overview', 'Inventory', 'Redistribution'].includes(page) ? (
                    ...
                    <a className="button secondary" href={`${API_ORIGIN}/api/reports/export`}>
