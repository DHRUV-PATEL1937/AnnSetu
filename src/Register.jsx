      ...
      <section className="login-form register-form-section">
        ...
        <div className="login-box register-box">
          ...
          <div className="register-helper-notes">
            <p>
              <ShieldCheck size={14} /> Passwords hashed securely with bcrypt. Sessions protected by
              HttpOnly tokens. All operations comply with FSSAI & SIH 26234 food safety invariants.
            </p>
          </div>
        </div>
      </section>
